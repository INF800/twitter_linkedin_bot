...
def main():
    ...
    for tweet in tweets:
        ...
        text = f"Original Twitter Post: https://twitter.com/{link}\n\n\n\n\nResharing bot tweets/retweets of https://twitter.com/inf800. Built for #MachineLearning #DeepLearning #DataScience and #ComputerScience geeks 🤩👨‍🏫"
