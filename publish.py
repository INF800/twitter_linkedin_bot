...
# If you like my work, please add this line in the content you are publishing.
CITE_ME_PLEASE = "This message was automatically generated by @gov-ai."
...
def main():
    ...
    for tweet in tweets:
        ...
        text = f"Twitter Post: https://twitter.com/{link}\n\nPosting #MachineLearning content from Twitter to Linkedin. Double tap on the image to democratize machine learnining. {CITE_ME_PLEASE}"
