...
def main():
    ...
    for tweet in tweets:
        ...
        text = f"Twitter Post: https://twitter.com/{link}\n\nPosting #MachineLearning content from Twitter to Linkedin. Double tap on the image to democratize machine learnining. This message was automatically generated by @gov-ai."
